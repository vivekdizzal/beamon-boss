...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2016 at 02:10 PM
...
--
-- Table structure for table `boss_fixture_list`
--

CREATE TABLE IF NOT EXISTS `boss_fixture_list` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `boss_tooling_material_cost`
--

CREATE TABLE IF NOT EXISTS `boss_tooling_material_cost` (
`id` bigint(20) NOT NULL,
...
--
-- Table structure for table `boss_tooling_timing_cost`
--

CREATE TABLE IF NOT EXISTS `boss_tooling_timing_cost` (
`id` int(11) NOT NULL,
...
--
-- Indexes for table `boss_fixture_list`
--
ALTER TABLE `boss_fixture_list`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `boss_tooling_material_cost`
--
ALTER TABLE `boss_tooling_material_cost`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `boss_tooling_timing_cost`
--
ALTER TABLE `boss_tooling_timing_cost`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `boss_fixture_list`
--
ALTER TABLE `boss_fixture_list`
...
--
-- AUTO_INCREMENT for table `boss_tooling_material_cost`
--
ALTER TABLE `boss_tooling_material_cost`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `boss_tooling_timing_cost`
--
ALTER TABLE `boss_tooling_timing_cost`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
